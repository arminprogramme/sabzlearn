...
<div class=" bg-white border border-gray-200 main-card shadow dark:bg-gray-800 dark:border-gray-700 w-full card">
    <a href="#">
        <img class="h-full w-full" src={this.props.image} alt="" />
    </a>
    <div class="p-5 h-full flex flex-col">
        ...
        <p class="mb-3 font-normal py-1 text-gray-700 dark:text-gray-400">{this.props.desc}</p>
        <div className="flex justify-between more-detail-product items-center">
            ...
            <span className=' px-1 font-bold'>{this.props.time}</span>
        ...
        <div className='fake-price flex justify-start line-through font-bld'>
            <p>{Number(this.props.fake).toLocaleString('fa-ir')}</p>
        </div>
        ...
        <div class=" bg-white border border-gray-200 main-card shadow dark:bg-gray-800 dark:border-gray-700 w-full card">
            ...
            <div class="p-5 h-full flex flex-col">
                ...
                <p class="mb-3 font-normal py-3 text-gray-700 dark:text-gray-400">{this.props.desc}</p>
                <div className="flex justify-between more-detail-product items-center">
                    <div className="comment flex items-center text-right text-yellow-300">
                    <svg class="w-4 h-4 text-yellow-300 mr-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
                        <path d="M20.924 7.625a1.523 1.523 0 0 0-1.238-1.044l-5.051-.734-2.259-4.577a1.534 1.534 0 0 0-2.752 0L7.365 5.847l-5.051.734A1.535 1.535 0 0 0 1.463 9.2l3.656 3.563-.863 5.031a1.532 1.532 0 0 0 2.226 1.616L11 17.033l4.518 2.375a1.534 1.534 0 0 0 2.226-1.617l-.863-5.03L20.537 9.2a1.523 1.523 0 0 0 .387-1.575Z"/>
