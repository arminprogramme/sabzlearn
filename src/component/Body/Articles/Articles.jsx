...
class Articles extends Component {
    ...
    constructor(props){
        ...
        this.state = {
            articles : [
                ...
                {id : 1 , image : 'images/article/android-on-javascript-768x432.png' , title : ' نصب جاوا اسکریپت در اندروید | با 4 روش جدید | 2023' , desc : 'چطوری باید جاوا اسکریپت رو بر روی اندروید نصب کنیم ؟ همونطور که می‌دونید در دنیای برنامه نویسی همانند دنیای واقعی، با زبان‌های بسیاری روبه‌رو هستیم. یکی از محبوب‌ترین زبان‌های  تکنولوژی دنیاست که' , author : 'عرفان جهانشاهلو' , date : '1402/07/01' },
                {id : 1 , image : 'images/article/شاخص-نهایی-768x512.jpg' , title : 'آموزش گام به گام ساخت ویروس با پایتون' , desc : 'ساخت ویروس با پایتون، یکی از مباحث مورد علاقه افرادیه که تو زمینه امنیت و تست نفوذ کار میکنن هست. در واقع شما با ساخت ویروس، درک کاملی از ساختار و الگوریتم نویسی در پایتون آشنایی بیشتری…' , author : 'ارمیا مزرعه' , date : '1402/07/09' },
            ]
        }
    }
    ...
    render() {
        return (
            <div className='text-right body-item'>
                <Title titleSubject="آخرین مقالات" titleText="مقالات بروز برنامه نویسی" titleColor="#F43F5E"/>

               <div className="grid gap-6 lg:grid-cols-2 xl:grid-cols-4 article-container">
