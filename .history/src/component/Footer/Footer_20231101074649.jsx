...
<footer class="bg-transparent">
    <div class="mx-auto w-full max-w-screen-xl">
      <div class="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
        <div>
            <h2 class="mb-6  font-semibold text-gray-900 uppercase dark:text-white">شبکه های اجتماعی</h2>
            <ul class="text-gray-500 dark:text-gray-400 font-medium">
                <li class="mb-4 flex justify-end items-center">
                    <a href="#" class="font-bold  px-2 text-lg">@ArminPr_17</a>
        ...
        <div>
            <h2 class="mb-6  font-semibold text-gray-900 uppercase dark:text-white">لینک های مفید</h2>
            <ul class="text-gray-500 dark:text-gray-400 font-medium">
                <li class="mb-4">
        ...
        <div>
            <h2 class="mb-6  font-semibold text-gray-900 uppercase dark:text-white">دسترسی سریع</h2>
            <ul class="text-gray-500 dark:text-gray-400 font-medium">
                <li class="mb-4">
        ...
        <div>
            <h2 class="mb-6  font-semibold  text-white">درباره ما</h2>
    ...
    <div class="px-4 py-6  md:flex md:items-center md:justify-between">
        ...
        <p className='text-white'> ساخته شده با ❤ توسط آرمین</p>
      </div>
    </div>
</footer>
