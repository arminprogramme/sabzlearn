...
<div class="max-w-sm bg-white border border-gray-200 main-card shadow dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="p-5">
        <div className="categories flex justify-end">
            <div className="cat-1-product mx-2">{this.props.cat1}</div>
            <div className="cat-2-product ">{this.props.cat2}</div>
        </div>
        <a href="#">
            <h5 class="mb-2 text-2xl  tracking-tight title-product text-gray-900 dark:text-white">JS برای برنامه نویسان Clean Code</h5>
        </a>
        ...
        <div className="flex justify-between">
                <div className="price-product" lang='fa'>{Number(1500000).toLocaleString('fa-ir')}</div>
                <div className="users-product flex items-center text-white">
                    <span className='px-2'>{Number(52).toLocaleString('fa-ir')}</span>
                    <i className="fa fa-user"></i>
                </div>
            </div>
    </div>
