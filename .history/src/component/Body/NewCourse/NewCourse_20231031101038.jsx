    ...
    constructor(props){
        ...
        this.state = {
            newCourses : [
                ...
                {id : 3 , image : 'image/product/PWA-min-1-768x432.png' , title : 'PWA  آموزش پروژه محور' , cat1 : 'فرانت اند' , cat2 : '' , desc : 'کلمه PWA مخفف Progressive Web App بوده و یه تکنولوژی تقریبا جدیده که میتونیم بهمون اجازه میده وب‌سایتی که توسعه…' , teacher : 'محمدامین سعیدی راد' , time : '' , price : 5 , users : 55 ,},
