...
class Instagram extends Component {
    render() {
        return (
            <div className='text-right lg:flex justify-between items-center instagram-item body-item' dir="rtl">
                <div className="insta-content text-center lg:text-right">
                ...
                <div className="insta-button text-center px-2 py-3 ">
                    <button className='flex justify-center text-center w-full  items-center py-2 '>
