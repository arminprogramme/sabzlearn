...
<div class=" article-item  border border-gray-200 my-2 text-right rounded-lg shadow h-auto">
    <div className='img-article'>
        <img class="rounded-t-lg w-full h-full" src={this.props.image} alt="" />
    </div>
    <div class="p-5 article-content flex flex-col items-stretch h-auto">
        <a href="#">
